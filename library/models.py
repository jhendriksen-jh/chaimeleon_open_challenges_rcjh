...
class ProstateCombinedModel(nn.Module):
    def __init__(self):
        ...
        # image layers
        self.image_conv1 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=7, stride=2, padding=3) # 240
        self.image_conv2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=5, stride=1, padding='same') # 120
        self.image_conv3 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, stride=1, padding='same') # 120
        self.image_maxpool2 = nn.MaxPool2d(kernel_size=2) # 60
        self.image_conv4 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, stride=2, padding=1) # 30
        self.image_conv5 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding='same') # 30
        self.image_maxpool3 = nn.MaxPool2d(kernel_size=3) # 10
        self.image_conv6 = nn.Conv2d(in_channels = 256, out_channels=384, kernel_size=3, stride=1, padding='same') # 10
        ...
        # combo layers
        self.combo_fc1 = nn.Linear(in_features = 16, out_features=16)
        self.combo_fc2 = nn.Linear(in_features = 32, out_features=32)
